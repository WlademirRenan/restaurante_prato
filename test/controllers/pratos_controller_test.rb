...
class PratosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create prato" do
    assert_difference('Prato.count') do
      post pratos_url, params: { prato: { descricao: @prato.descricao, preco: @prato.preco, restaurante_id: @prato.restaurante_id } }
    end
  ...
  test "should update prato" do
    patch prato_url(@prato), params: { prato: { descricao: @prato.descricao, preco: @prato.preco, restaurante_id: @prato.restaurante_id } }
